...
#define correctBooleanSize 7
#define correctPayloadSize 20
#define correctFlightComputerSize 64
#define correctVariable1Size 4
#define correctVariable2Size 5
#define correctVariable3Size 7
#define correctVariable4Size 8
